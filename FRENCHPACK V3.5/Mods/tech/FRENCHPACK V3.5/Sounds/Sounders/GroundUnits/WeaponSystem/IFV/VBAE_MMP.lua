...
VBAE_MMP_weapons = weapons:new()
VBAE_MMP_weapons:addTurret(1, "GndTech/TurretRotation_Electric")
VBAE_MMP_weapons:addLauncher(1, 1, automatic_gun_25mm)
VBAE_MMP_weapons:addLauncher(1, 2, automatic_gun_25mm)
VBAE_MMP_weapons:addLauncher(1, 4, machinegun_MG3)
