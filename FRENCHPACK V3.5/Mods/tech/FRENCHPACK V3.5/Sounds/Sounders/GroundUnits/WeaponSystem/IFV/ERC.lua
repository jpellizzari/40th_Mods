...
ERC_weapons = weapons:new()
ERC_weapons:addTurret(1, "GndTech/TurretRotation_Electric")
ERC_weapons:addLauncher(1, 1, tank_gun_105mm)
ERC_weapons:addLauncher(1, 2, tank_gun_105mm)
ERC_weapons:addLauncher(1, 3, PKT)
