...
B_757 =  {
	...
	shape_table_data 	= 
	{
		...
		main_gear_pos = 	{-0.200,	-4.70,	3.77},
		radar_can_see_ground	=	true,
		nose_gear_pos = 	{21.39,	-4.60,	0},
		AOA_take_off	=	0.14,
		stores_number	=	0,
		bank_angle_max	=	45,
		Ny_min	=	0.5,
		...
		engines_count	=	2,
		wing_tip_pos = 	{-3.71,	0.00,	18.80},
		nose_gear_wheel_diameter	=	0.928,
		main_gear_wheel_diameter	=	1.082,
		engines_nozzles = 
		{
			[1] = 
			{
...
--		air_refuel_receptacle_pos = 	{6.731,	0.825,	0.492},
	...
	DamageParts = 
	{  
		[1] = "B_757-OBLOMOK-WING-R", -- wing R
		[2] = "B_757-OBLOMOK-WING-L", -- wing L
