...
B_737 =  {
	...
	shape_table_data 	= 
	{
		...
		main_gear_pos = 	{-0.38,	-4.06,	3.10},
		radar_can_see_ground	=	true,
		nose_gear_pos = 	{12.77,	-3.96,	0},
		AOA_take_off	=	0.14,
		stores_number	=	0,
		bank_angle_max	=	45,
		Ny_min	=	0.5,
		...
		engines_count	=	2,
		wing_tip_pos = 	{-5.126,	-0.5,	17.10},
		nose_gear_wheel_diameter	=	0.626,
		main_gear_wheel_diameter	=	1.009,
		engines_nozzles = 
		{
			[1] = 
			{
...
--		air_refuel_receptacle_pos = 	{6.731,	0.825,	0.492},
	...
	DamageParts = 
	{  
		[1] = "B_737-OBLOMOK-WING-R", -- wing R
		[2] = "B_737-OBLOMOK-WING-L", -- wing L
