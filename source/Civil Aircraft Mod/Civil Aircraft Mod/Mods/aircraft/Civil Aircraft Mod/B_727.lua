...
B_727 =  {
	...
	shape_table_data 	= 
	{
		...
		main_gear_pos = 	{-0.555,	-3.90,	2.705},
		radar_can_see_ground	=	true,
		nose_gear_pos = 	{15.629,	-3.80,	0},
		AOA_take_off	=	0.14,
		stores_number	=	0,
		bank_angle_max	=	45,
		Ny_min	=	0.5,
		...
		tanker_type	=	0,
		wing_area	=	226,
		wing_span	=	32.92,--B-52 60.0,
		thrust_sum_max	=	38100,
		thrust_sum_ab	=	38100,
		Vy_max	=	10,
		length	=	40.59,--tu-160 67.0,
		height	=	10.36,--c-17 19.60,
		flaps_maneuver	=	0.5,
		Mach_max	=	0.9,--0.82,
		range	=	12247,
		crew_size	=	3,
		...
		engines_count	=	3,
		wing_tip_pos = 	{-7.096,	-1.475,	16.43},
		nose_gear_wheel_diameter	=	0.79,
...
--		air_refuel_receptacle_pos = 	{6.731,	0.825,	0.492},
	...
	DamageParts = 
	{  
		[1] = "B_727-OBLOMOK-WING-R", -- wing R
		[2] = "B_727-OBLOMOK-WING-L", -- wing L
