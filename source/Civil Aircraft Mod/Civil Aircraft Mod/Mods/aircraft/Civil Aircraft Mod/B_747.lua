...
B_747 =  {
	...
	shape_table_data 	= 
	{
		...
		main_gear_pos = 	{-0.15,	-5.95,	5.50},
		radar_can_see_ground	=	true,
		nose_gear_pos = 	{24.60,	-5.85,	0},
		AOA_take_off	=	0.14,
		stores_number	=	0,
		bank_angle_max	=	45,
		Ny_min	=	0.5,
		...
		tanker_type	=	0,
		wing_area	=	226,
		wing_span	=	56.4,--B-52 60.0,
		thrust_sum_max	=	38100,
		thrust_sum_ab	=	38100,
		Vy_max	=	10,
		length	=	54.1,--tu-160 67.0,
		height	=	16.79,--c-17 19.60,
		flaps_maneuver	=	0.5,
		Mach_max	=	0.9,--0.82,
		range	=	12247,
		crew_size	=	3,
		...
		engines_count	=	4,
		wing_tip_pos = 	{-11.36,	-0.08,	29.75},
		nose_gear_wheel_diameter	=	1.28,
		main_gear_wheel_diameter	=	1.36,
		engines_nozzles = 
		{
			[1] = 
			{
...
--		air_refuel_receptacle_pos = 	{6.731,	0.825,	0.492},
	...
	DamageParts = 
	{  
		[1] = "B_747-OBLOMOK-WING-R", -- wing R
		[2] = "B_747-OBLOMOK-WING-L", -- wing L
