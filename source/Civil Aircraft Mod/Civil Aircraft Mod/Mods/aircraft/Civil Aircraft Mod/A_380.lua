...
A_380 =  {
	...
	shape_table_data 	= 
	{
		...
		main_gear_pos = 	{-0.00,	-6.07,	5.50},
		radar_can_see_ground	=	true,
		nose_gear_pos = 	{31.86,	-5.70,	0},
		AOA_take_off	=	0.14,
		stores_number	=	0,
		bank_angle_max	=	45,
		Ny_min	=	0.5,
		...
		engines_count	=	4,
		wing_tip_pos = 	{-13.37,	1.588,	39.69},
		nose_gear_wheel_diameter	=	1.39,
		main_gear_wheel_diameter	=	1.48,
		engines_nozzles = 
		{
			[1] = 
			{
...
--		air_refuel_receptacle_pos = 	{6.731,	0.825,	0.492},
	...
	DamageParts = 
	{  
		[1] = "A_380-OBLOMOK-WING-R", -- wing R
		[2] = "A_380-OBLOMOK-WING-L", -- wing L
