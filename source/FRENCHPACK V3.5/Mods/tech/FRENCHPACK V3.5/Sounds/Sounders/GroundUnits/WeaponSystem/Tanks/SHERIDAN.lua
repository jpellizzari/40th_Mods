...
SHERIDAN_weapons = weapons:new()
SHERIDAN_weapons:addTurret(1, "GndTech/TurretRotation_Electric")
SHERIDAN_weapons:addLauncher(1, 1, howitzer_2A33)
SHERIDAN_weapons:addLauncher(1, 2, PKT)
