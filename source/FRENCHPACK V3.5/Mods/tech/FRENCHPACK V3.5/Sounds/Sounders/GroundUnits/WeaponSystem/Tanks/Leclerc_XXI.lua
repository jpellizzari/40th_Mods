...
Leclerc_XXI_weapons = weapons:new()
Leclerc_XXI_weapons:addTurret(1, "GndTech/TurretRotation_Electric")
Leclerc_XXI_weapons:addLauncher(1, 1, tank_gun_2A46)
Leclerc_XXI_weapons:addLauncher(1, 2, tank_gun_2A46)
Leclerc_XXI_weapons:addLauncher(1, 3, machinegun_12_7_M2)
Leclerc_XXI_weapons:addLauncher(2, 1, PKT) -- 7.62 machine gun
