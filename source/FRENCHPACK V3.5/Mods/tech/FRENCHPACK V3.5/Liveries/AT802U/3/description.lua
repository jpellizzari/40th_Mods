...
livery = 
{
    ...
    --]]
    --{"-40", 0, "test 40", true};
    {"AT802_tx", 0, "AT802_tx_USA", false};
    --{"at802 glass", 0, "glass", true};
    --{"at802 glass", 1, "glass_bump", true};
    --{"cloth", 0, "bf-109 cloth", true};
    --{"cloth", 1, "bf-109 cloth n", true};
    --{"face", 0, "bf-109 face", true};
    --{"head", 0, "bf-109 helmet", true};
}
